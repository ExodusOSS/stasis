...
// drives load-mode getFile directly). Wire it as Metro's `transformer.transformerPath`
// in load mode; see the source for the load asymmetry that lets this run per-worker
